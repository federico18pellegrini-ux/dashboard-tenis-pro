      ...
      <div className="w-full max-w-sm space-y-8 bg-slate-900 p-10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-slate-800/50">
        ...
        <form className="space-y-6">
          ...
          <div className="space-y-4 pt-2">
            <button
              formAction={login}
              className="w-full flex justify-center py-5 px-4 rounded-2xl shadow-[0_10px_30px_rgba(189,253,44,0.15)] text-sm font-black text-slate-950 bg-[#bdfd2c] hover:bg-[#aef026] hover:scale-[1.02] active:scale-95 transition-all uppercase tracking-widest"
            >
              Entrar al Panel
            </button>

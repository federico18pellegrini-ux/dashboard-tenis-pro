                    ...
                    if (working) {
                      return (
                        <div key={`${hour}-${dow}-free`} className="border-b border-l border-slate-800/80 p-2 min-h-[56px]">
                          ...
                          >
                            <span className="absolute inset-0 flex items-center justify-center text-gray-950/80 dark:text-[#ADFF2F]/70 text-lg font-black opacity-0 group-hover:opacity-100 transition-opacity">
                              +
                            </span>
                          </button>
                        </div>

  ...
  return (
    <>
      <button 
        ...
        className="bg-[#bdfd2c] text-slate-950 px-6 py-3 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-[#a5e620] transition-all shadow-[0_0_20px_rgba(189,253,44,0.15)] flex items-center gap-2"
      >
            ...
            <form action={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3 border-t border-slate-800/60 pt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <button type="button" onClick={addDayRow} className="text-[#bdfd2c] text-[9px] font-black uppercase tracking-widest hover:underline">+ Agregar Día</button>
                </div>
                    ...
                    <div key={index} className="grid grid-cols-12 gap-2 items-center bg-slate-950 p-3 rounded-2xl border border-slate-800 group transition-all hover:border-slate-700">
                      ...
                      <div className="col-span-3">
                        <select 
                          ...
                          className="w-full bg-transparent text-[11px] font-bold text-[#bdfd2c] outline-none"
                        >
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button 
                  ...
                  className="flex-1 bg-[#bdfd2c] text-slate-950 py-4 rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl hover:bg-[#a5e620] disabled:opacity-50 transition-all"
                >

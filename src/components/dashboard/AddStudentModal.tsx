            ...
            <form action={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-3 border-t border-slate-800/60 pt-6">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <button type="button" onClick={addDayRow} className="text-gray-950 dark:text-[#ADFF2F] text-[9px] font-black uppercase tracking-widest hover:underline">+ Agregar Día</button>
                </div>
                    ...
                    <div key={index} className="grid grid-cols-12 gap-2 items-center bg-slate-950 p-3 rounded-2xl border border-slate-800 group transition-all hover:border-slate-700">
                      ...
                      <div className="col-span-3">
                        <select 
                          ...
                          className="w-full bg-transparent text-[11px] font-bold text-gray-950 dark:text-[#ADFF2F] outline-none"
                        >
